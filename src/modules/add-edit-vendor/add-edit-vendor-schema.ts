...
export const addEditVendorSchema = baseVendorSchema
  .extend({
    password: z
      .string()
...
export type AddEditVendorFormData = z.infer<typeof addEditVendorSchema>;

// For editing, password fields are optional
export const editVendorSchema = baseVendorSchema
  .extend({
