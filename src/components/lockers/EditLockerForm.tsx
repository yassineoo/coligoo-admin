...
interface EditLockerFormProps {
  lockerId: string;
}

export default function EditLockerForm({ lockerId }: EditLockerFormProps) {
  ...
  useEffect(() => {
    setFormData({
      lockerName: "Algiers Center 01",
      reference: "LKR-ALG-001",
      numberOfCompartments: "10",
      wilaya: "Alger",
      commune: "Bordj El Kiffan",
      address: "Palm Street, Bordj El Kiffan District, Algiers 16120, Algeria",
    });
  }, [lockerId]);
