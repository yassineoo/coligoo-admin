      ...
      >
        <div className="sticky top-0 bg-white z-10 px-6 py-6 border-b border-gray-100">
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={() =>
                router.push(`/dashboard/lockers/${locker.id}/edit`)
              }
              className="inline-flex items-center px-3 py-2 text-sm font-medium text-white bg-[#FF5A01] border border-[#FF5A01] rounded-lg hover:bg-orange-600 transition"
            >
              <svg
                width="17"
                height="17"
