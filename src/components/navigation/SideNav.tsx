...
export default function SideNav() {
  ...
  const sidebarItems: SidebarItem[] = [
    ...
    { iconName: "vendors", label: "Vendors", path: "/dashboard/vendors" },
    { iconName: "delivery", label: "Delivery", path: "/dashboard/delivery" },
    { iconName: "hubs", label: "Hubs", path: "/dashboard/hubs" },
    { iconName: "orders", label: "Orders", path: "/dashboard/order-lists" },
  ...
  function iconSrc(name: string, active: boolean) {
    ...
    return `/icons/sidenav/${name}${suffix}.svg`;
  }
